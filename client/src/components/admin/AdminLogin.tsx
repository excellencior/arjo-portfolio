...
const AdminLogin: React.FC<AdminLoginProps> = ({ 
  ...
  if (step === 'email') {
    return (
      <div className="relative min-h-[60vh] flex flex-col justify-start w-full">
        <div className="absolute top-4 right-4 z-50">
          <ThemeToggle />
        </div>
        <div className="max-w-md mx-auto pt-16 w-full">
          <motion.div 
          ...
          >
            ...
            <form onSubmit={onSendCode} className="space-y-3">
              <input 
                ...
                className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 rounded-md outline-none border border-slate-200 dark:border-slate-700 focus:border-blue-500 transition-all font-arial text-sm placeholder:font-arial placeholder:text-slate-400"
                required
              />
              <button 
                type="submit" 
        ...
        >
          ...
          <form onSubmit={onVerifyCode} className="space-y-3">
            <input 
              ...
              className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 rounded-md outline-none border border-slate-200 dark:border-slate-700 focus:border-blue-500 text-center text-xl tracking-[1em] font-arial placeholder:font-arial placeholder:text-slate-400 transition-all"
              required
            />
            <button 
              type="submit" 
